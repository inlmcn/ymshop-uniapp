...
const handleClassObject = (props) => {
  let className = 'HealthCoast-space'
  ...
  if (border) {
    className += ' HealthCoast-space-border'
  }
  if (direction) {
    className += ` HealthCoast-space-${ direction }`
  }
  if (wrap) {
    className += ` HealthCoast-space-${ wrap }`
  }
  if (align) {
    className += ` HealthCoast-space-align-${ align }`
  }
  if (justify) {
    className += ` HealthCoast-space-justify-${ justify }`
  }
  if(props.gap){
    className += ` gap`
