		...
		<view class="uv-tabs__wrapper">
			...
			<view class="uv-tabs__wrapper__scroll-view-wrapper">
				...
				>
					...
					>
						<view
							...
							:class="[`uv-tabs__wrapper__nav__item-${index}`, item.disabled && 'uv-tabs__wrapper__nav__item--disabled',current === index && 'van-tab--active']"
						>
              <div class="time-bar-item">
                ...
                >
                  <text>已结束</text>
                  <uv-count-down :time="item.countdown" format="HH:mm:ss"></uv-count-down>
                </div>
              </div>
							<uv-badge
