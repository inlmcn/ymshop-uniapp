<script setup>
import { createBuryPoint } from "@/src/api/modules/global";
import cookie from "@/src/utils/helpers/cookie";
import { onLaunch, onShow } from "@dcloudio/uni-app";
import { useMainStore } from "@/src/stores/modules/useMainStore";
// import { ensureUserActionSetOnce } from "@/src/api/tencentAds";
import TencentAdSDK from "@/src/utils/helpers/tencentAd.js";
import BindingHelper from "@/src/utils/helpers/tencentAdBindingHelper.js";
import { checkTheUser } from "@/src/api/modules/auth";
import { orderBindingBiliTrackId } from "@/src/api/modules/order";
import { autoReceiveCoupon } from "@/src/api/modules/coupon";
