    ...
    <view v-if="!isPhone"
      ...
      <view v-if="!isRange"
        ...
        <view v-if="hasTime"
          ...
          <input class="uni-date__input text-center"
                 type="text"
                 v-model="inputDate"
        ...
        <view v-if="hasTime"
          ...
          <text class="confirm-text"
                @click="confirmSingleChange">{{ okText }}
          </text>
        </view>
      </view>
      ...
      <view v-else
        ...
        <view v-if="hasTime"
          ...
          <view class="popup-x-header--datetime">
            <input class="uni-date__input uni-date-range__input"
                   type="text"
        ...
        <view v-if="hasTime"
          ...
          <text class="confirm-text"
                @click="confirmRangeChange">{{ okText }}
          </text>
        </view>
      </view>
    </view>

    <Calendar v-if="isPhone"
              ref="mobile"
              :clearDate="false"
              :date="calendarDate"
...
import UniIcons from "@/pages/components/Uni/uni-icons/uni-icons.vue";
